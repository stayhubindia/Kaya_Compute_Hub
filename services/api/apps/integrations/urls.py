...
urlpatterns = [
    ...
    path('colab/drive-mount/start/', views.colab_drive_mount_start, name='colab-drive-mount-start'),
    path('colab/drive-mount/complete/', views.colab_drive_mount_complete, name='colab-drive-mount-complete'),
